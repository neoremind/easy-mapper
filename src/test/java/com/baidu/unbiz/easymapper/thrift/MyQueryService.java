...
public class MyQueryService {
  ...
  public interface AsyncIface {
    ...
    public void echoInt(int id, AsyncMethodCallback resultHandler) throws TException;

    public void helloVoid(AsyncMethodCallback resultHandler) throws TException;

    public void submitQuery(QueryRequest query, AsyncMethodCallback resultHandler) throws TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_echoInt(int id) throws TException
    {
    ...
    public int recv_echoInt() throws TException
    {
    ...
    public void send_submitQuery(QueryRequest query) throws TException
    {
    ...
    public QueryResponse recv_submitQuery() throws TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class echoInt_call extends org.apache.thrift.async.TAsyncMethodCall {
      private int id;
      public echoInt_call(int id, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.id = id;
      }
    ...
    public static class submitQuery_call extends org.apache.thrift.async.TAsyncMethodCall {
      ...
      public submitQuery_call(QueryRequest query, AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.query = query;
      }
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class echoInt<I extends Iface> extends org.apache.thrift.ProcessFunction<I, echoInt_args> {
      ...
      public echoInt_result getResult(I iface, echoInt_args args) throws TException {
        echoInt_result result = new echoInt_result();
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class echoInt<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, echoInt_args, Integer> {
      ...
      public void start(I iface, echoInt_args args, AsyncMethodCallback<Integer> resultHandler) throws TException {
    ...
    public static class submitQuery<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, submitQuery_args, QueryResponse> {
      ...
      public void start(I iface, submitQuery_args args, AsyncMethodCallback<QueryResponse> resultHandler) throws TException {
  ...
  public static class echoInt_args implements org.apache.thrift.TBase<echoInt_args, echoInt_args._Fields>, java.io.Serializable, Cloneable, Comparable<echoInt_args>   {
    ...
    private static class echoInt_argsStandardScheme extends StandardScheme<echoInt_args> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, echoInt_args struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, echoInt_args struct) throws TException {
        struct.validate();
    ...
    private static class echoInt_argsTupleScheme extends TupleScheme<echoInt_args> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, echoInt_args struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetId()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, echoInt_args struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.id = iprot.readI32();
  ...
  public static class echoInt_result implements org.apache.thrift.TBase<echoInt_result, echoInt_result._Fields>, java.io.Serializable, Cloneable, Comparable<echoInt_result>   {
    ...
    private static class echoInt_resultStandardScheme extends StandardScheme<echoInt_result> {
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, echoInt_result struct) throws TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, echoInt_result struct) throws TException {
        struct.validate();
    ...
    private static class echoInt_resultTupleScheme extends TupleScheme<echoInt_result> {
      ...
      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, echoInt_result struct) throws TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, echoInt_result struct) throws TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = iprot.readI32();
